...
const Hero = () => {
  return (
    <section className=" flex flex-col-reverse md:flex-row font-Ubuntu  md:justify-between w-full h-screen items-center px-6 xl:mr-10">
      <div className="flex  flex-col  pb-20 xl:ml-20 md:pt-16 pt-24 lg:pl-10 ">
        ...
        <button
          type="button"
          className="my-3 md:w-80 w-2/3 py-2.5 px-5 mr-2 mb-2 text-sm font-medium text-white focus:outline-none hover:bg-white rounded-lg  '
